package driverfeedbackservice.cucumber.steps;
...
@ActiveProfiles("test")
public class DriverFeedbackSteps {
    ...
    public void the_following_driver_feedback_details_in_JSON(String docString) {
    ...
    public void a_driver_feedback_is_created() {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<String> request = new HttpEntity<>(payload, headers);
        ResponseEntity<String> createResponse = restTemplate.postForEntity("/api/v1/driver-feedbacks/", request, String.class);
    ...
    public void the_feedback_should_be_deleted() {
        ResponseEntity<String> getResponse = restTemplate.getForEntity(resolveUrl("/api/v1/driver-feedbacks/{feedbackId}"), String.class);
